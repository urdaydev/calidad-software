...
if ($tipo_usuario == "" || $username == "" || $password == "" || $password_repeat == "" || $direccion == "" || $imagen == "" || $dni == "" || $nombres == "" || $apellidos == "" || $telefono == "") {
    ...
    $sql2 = "INSERT INTO `persona` (`dni`, `nombres`, `a_paterno`, `a_materno`, `direccion`, `n_telefono`) VALUES ('$dni', '$nombres', '$apellidos[0]', '$apellidos[1]', '$direccion', '$telefono');";

    # Ejecutamos la consulta    en la base de datos
    if ($con->query($sql2) === TRUE) {
        #obtenemos el id de la persona
        $id_persona = $con->query("SELECT id_persona FROM persona WHERE dni = '$dni'");
