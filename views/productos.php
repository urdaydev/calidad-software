<?php
    ...
    $sql = " SELECT producto.id_producto, categoria.nom_categoria, producto.nom_producto, producto.descripcion, producto.precio, producto.stock, producto.imagen FROM producto inner join categoria on producto.id_categoria = categoria.id_categoria WHERE producto.estado = 1;";
                ...
                <div class="body">
                    <form action="./create/producto.php" class="form" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-control">
                            ...
                            <input type="number" placeholder="Stock del producto" min="0" required name="stock" id="stock">
                        </div>
                        <div class="form-control">
                            <label for="">Imagen</label>
                            <input type="file" placeholder="Imagen del producto" required name="imagen" id="imagen">
                        </div>
            ...
            <div class="modal-content">
                ...
                <div class="body">
                    ...
                    <div class="form-control">
                        ...
                        <div class="form-control">
                            <label for="">Imagen</label>
                            <input type="file" placeholder="Imagen del producto" name="imagen" id="imagen">
                        </div>
                        <div class="btns-container">
                            <btn class="btn btn-cancel">Cancelar</btn>
