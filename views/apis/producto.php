...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Validar los datos
    if (!isset($id_producto, $id_proveedor, $id_categoria, $nom_producto, $descripcion, $precio, $stock)) {
    ...
    if (isset($_FILES['imagen'])) {
        ...
        $sql = "UPDATE producto SET id_proveedor = ?, id_categoria = ?, nom_producto = ?, descripcion = ?, precio = ?, stock = ? WHERE id_producto = ?";
        $stmt = $con->prepare($sql);
        $stmt->bind_param("iisssii", $id_proveedor, $id_categoria, $nom_producto, $descripcion, $precio, $stock, $id_producto);
