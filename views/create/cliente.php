...
if (!isset($_POST['dni']) || !isset($_POST['nombres']) || !isset($_POST['a_paterno']) || !isset($_POST['a_materno'])) {
    ...
    if ($result > 0) {
        ...
        $sql = "INSERT INTO persona (dni, nombres, a_paterno, a_materno) VALUES ('$dni', '$nombres', '$a_paterno', '$a_materno')";
        $query = mysqli_query($con, $sql);
