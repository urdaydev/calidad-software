...
btnEditModal.forEach((btn) => {
    btn.addEventListener('click', () => {
        ...
        .then((data) => {
            ...
            const { id_proveedor: idProveedor, id_categoria: idCategoria, nom_producto: nombre, descripcion, precio, stock } = data;
            function setSelectedOption(selector, idValue, modalClass = '.modalUpdate') {
                const options = document.querySelectorAll(`${modalClass} select#${selector} option`);
            ...
            const descripcionInput = document.querySelector('.modalUpdate #descripcion');
